    ...
    <div class="row">
        <div class ="col-xs-12">
            ...
            <div class="alert alert-info">
                <strong>Selamat Datang di SI Data Atlet KONI Asahan</strong>
            </div>
        </div>
    </div>
    <div class="row">
        ...
        <div class="col-sm-9 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Data Atlet</h3>
                </div>
                <div class="panel-body">
                     <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th>ID Atlet</th><th>Cabang Olahraga</th><th width="20%">Nama</th><th>Tgl Lahir</th><th>Jenis Kelamin</th><th>Alamat</th><th>Medali</th>
                            </tr>
                        </thead>
                        <tbody>
